...
import OrganizationProjectsView
...
const orgSettingsRoutes = [
  ...
  <IndexRoute key="index-org-settings" component={errorHandler(OrganizationGeneralSettingsView)} />,
...
function routes() {
  ...
  return (
    <Route path="/" component={errorHandler(App)}>
      ...
      <Route newnew path="/settings/" name="Settings" component={errorHandler(SettingsWrapper)}>
